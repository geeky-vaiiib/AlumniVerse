...
import { Edit3, Users, Briefcase, Calendar, TrendingUp } from "lucide-react"
...
export default function StatsSidebar() {
  ...
  // Simulate fetching stats (Supabase Removed)
  useState(() => {
    // Set immediate demo stats
    setTimeout(() => {
      setStats({
        alumni: 1247,
        openJobs: 24,
      ...
      <Card>
        <CardContent className="p-4">
          <Button
            ...
            onClick={async () => {
              const { signOut } = await import('../providers/AuthProvider').then(m => ({ signOut: m.useAuth }))
              // Simple redirect-based logout
